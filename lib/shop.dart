...
{
  const ShopPage({Key? key, required this.sharedPrefs}) : super(key: key);
          ...
          appBar: AppBar(
            ...
            actions: <Widget>[
              ...
              IconButton(
                ...
                onPressed: () {
                  setState(() {
                    widget.sharedPrefs.addCurrency(100);
                  });
                },
              )
            ],
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () {
                    /// Pop the drawer. BOOM. User at shop page
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SettingsPage(sharedPrefs: widget.sharedPrefs)
                        ));
                  },
                ),
